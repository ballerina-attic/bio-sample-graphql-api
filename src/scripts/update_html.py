...
def main():
    ...
    with open('src/scripts/graphql_api.bal', 'r') as action_obj:
        action_bbe = action_obj.readlines()

    old_text = soup.find('div', {'id':'graphql-api'})
    ...
    try:
        update = commit_file('index.html', updated_file, 'update-graphql-api', commit_message)[0]
